...
- with indexing enabled, scan dry-run initializes or updates the schema once any
  ...
  sidecar that can escape that root or overwrite another JSON file. These
  conditional effects still violate the mutation-free target invariant;
